...
export default function Member() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        //전역변수 onMember를 호출해서 formData에 저장된 내용을 보낸다
        onMember(formData);
    }
    return (
            ...
            <div className="inner">
                <div className="login-wrap">
                    ...
                    <form onSubmit={handleSubmit}>
                        <input type="text" name='uName' placeholder='이름' value={setFormData.uName} onChange={handleChange} />
                        ...
                        <input type="tel" name='phone' placeholder='전화번호' onChange={handleChange} />
